    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-3 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <!-- 登录展示 user menu ，否则展示登录按钮，默认展示登录按钮 -->
                <div class="flex items-center space-x-3">
                    <a
                        class="md:inline-block px-4 py-2 text-sm text-gray-900 bg-gray-100 rounded-lg dark:bg-gray-700 dark:text-white hover:text-blue-700"
                        @click="$router.push('/login')">Sign
                        in</a>

                </div>
                <button type="button"
                    class="flex order-last text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
