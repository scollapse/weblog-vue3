    ...
    <div v-if="visible" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <div class="flex justify-between items-start mb-4">
                ...
                <button @click="closeModal" class="text-gray-400 hover:bg-gray-200 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mt-10 flex justify-end space-x-2">
                    ...
                    <button type="button" @click="closeModal" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 rounded-lg border border-gray-300 text-sm px-5 py-2.5">
                        取消
                    </button>
                </div>
            </form>
