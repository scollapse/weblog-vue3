<template>
    <header class="bg-cyan-800 text-white flex justify-between items-center px-6 py-4 shadow-md">
      <!-- 左侧折叠按钮 -->
      <button
        class="text-white focus:outline-none hover:text-cyan-500"
        @click="toggleSidebar"
      >
        <svg v-if="!isSidebarCollapsed" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="relative flex items-center">
        <button
          class="focus:outline-none flex items-center space-x-2 hover:bg-cyan-800 px-3 py-1 rounded-lg"
