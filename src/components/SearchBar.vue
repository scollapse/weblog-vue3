            ...
            <template v-for="(field, index) in fields" :key="index">
                <div v-if="field.type === 'input'" class="flex space-x-4">
                    <template v-for="(value, idx) in field.values" :key="idx">
                        <input type="text" v-model="filters[value.key]" :placeholder="'请输入' + value.value"
                    ...
                    <template v-for="(value, idx) in field.values" :key="idx">
                        <div class="flex items-center">
                            <div class="relative">
                                ...
                                <input :id="getDatePickerId(value.key)" type="text"
